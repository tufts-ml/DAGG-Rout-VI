...
class Graph_Adj_Matrix_from_file(Dataset):
    ...
    :param data_statistics: data_statistics for the dataset generated by the mapping
    :random_bfs: Whether or not to do random_bfs
    """

    def __init__(self, args, graph_list, data_statistics, random_bfs=False):
    ...
    def __getitem__(self, idx):
        ...
        adj_feature_mat, perm = graph_to_matrix(
            G, self.data_statistics['node_forward'], self.data_statistics['edge_forward'],
...
class Graph_Adj_Matrix(Dataset):
    ...
    def __init__(self, args, data_statistics, random_bfs=False):
        # self.graph_list = graph_list
        self.data_statistics = data_statistics
        self.max_prev_node = args.max_prev_node
        # Head and tail of adjacency vector to consider for edge prediction
        ...
        len_node_vec, len_edge_vec, num_nodes_to_consider = get_attributes_len_for_graph_rnn(len(
            data_statistics['node_forward']), len(data_statistics['edge_forward']), self.max_prev_node, self.max_head_and_tail)
        self.feature_len = len_node_vec + num_nodes_to_consider * len_edge_vec
    ...
    def __call__(self, graph):
        ...
        adj_feature_mat = graph_to_matrix(
            graph, self.data_statistics['node_forward'], self.data_statistics['edge_forward'], self.max_prev_node, self.max_head_and_tail, self.random_bfs)[0]
